                            ...
                            <Col span={2}>
                                <Row>
                                    ...
                                    <Col span={12} align={"center"} style={{ marginTop: "20px" }}>
                                        {
                                            (body === "upper") ?
                                                <Button types={"active"} block value={"바로가기"} onClick={() => navigate('/toolprogress/upper')}  ></Button> :
                                                <Button types={"black"} block value={"바로가기"} onClick={() => navigate('/toolprogress/upper')}  ></Button>
                                        }
                            ...
                            <Col span={2}>
                                <Row>
                                    ...
                                    <Col span={12} align={"center"} style={{ marginTop: "20px" }}>
                                        {
                                            (body === "lower") ?
                                                <Button types={"active"} block value={"바로가기"} onClick={() => navigate('/toolprogress/lower')}></Button> :
                                                <Button types={"black"} block value={"바로가기"} onClick={() => navigate('/toolprogress/lower')}></Button>
                                        }
                            ...
                            <Col span={2}>
                                <Row>
                                    ...
                                    <Col span={12} align={"center"} style={{ marginTop: "20px" }}>
                                        {
                                            (body === "wrist") ?
                                                <Button types={"active"} block value={"바로가기"} onClick={() => navigate('/toolprogress/wrist')}></Button> :
                                                <Button types={"black"} block value={"바로가기"} onClick={() => navigate('/toolprogress/wrist')}></Button>
                                        }
