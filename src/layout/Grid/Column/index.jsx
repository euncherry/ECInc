...
const ColumnLayout = styled.div`
  transition: all 0.5s ease;
    ...
    ${props => props.alignContent ? `align-content : ` + props.alignContent + `;` : null};
 ...
 */
const Col = ({ span, style, justify, align, xs, sm, md, lg, xl, xxl, children, offset, colRef, alignContent }) => {
    ...
    return (
        ...
        <>
            <RowContext.Consumer>
                {(value) => (
                    <ColumnLayout ref={colRef} style={style} justify={justify} align={align} alignContent={alignContent} span={span} gutter={value} offset={offset} xs={xs} sm={sm} md={md} lg={lg} xl={xl} xxl={xxl}>
                        {children}
                    </ColumnLayout>
                )}
            </RowContext.Consumer>
